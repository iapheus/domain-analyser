...
function Server() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const apiList = ['cookies', 'dns-server', 'dns', 'get-ip', 'headers', 'hsts', 'http-security', 'mail-config', 'ports', 'redirects', 'robots-txt', 'ssl', 'status', 'tls', 'trace-route', 'txt-records', 'whois'];
